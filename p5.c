...
/**
 * p_uns - Prints an unsigned number
	...
	int flags, int width, int precision, int size)
{
	...
	return (w_uns(0, i, buffer, flags, width, precision, size));
}
/**
...
/**
 * p_hex - Prints an unsigned number in hexadecimal notation
 * @types: Lists of arguments
 * @buffer: Buffer array to handle print
 * @flags: Calculates active flags
 * @width: get width
...
/**
 * p_hex_upper - Prints an unsigned number in upper hexadecimal notation
 * @types: Lists of arguments
 * @buffer: Buffer array to handle print
 * @flags: Calculates active flags
 * @width: get width
